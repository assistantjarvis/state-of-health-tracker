...
import {
  ...
  CREATE_FOOD_CALORIES_HEADER,
  CREATE_FOOD_CARBS_ERROR_TEXT,
  CREATE_FOOD_CARBS_HEADER,
  CREATE_FOOD_FAT_ERROR_TEXT,
  CREATE_FOOD_FAT_HEADER,
  CREATE_FOOD_ITEM_BUTTON_TEXT,
  CREATE_FOOD_NAME_ERROR_TEXT,
  CREATE_FOOD_NAME_HEADER,
